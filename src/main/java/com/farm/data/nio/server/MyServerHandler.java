...
import com.farm.utils.SpringUtil;
...
public class MyServerHandler extends ChannelInboundHandlerAdapter {
    ...
    private static final FarmEquipmentService farmEquipmentService;

    static {
        farmEquipmentService = SpringUtil.getBean(FarmEquipmentService.class);
    }
